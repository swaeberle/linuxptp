...
static const Octet profile_id_62439_3_single[] = {0x00, 0x0C, 0xCD, 0x00, 0x01, 0x00};
static const Octet profile_id_62439_3_doubly[] = {0x00, 0x0C, 0xCD, 0x00, 0x01, 0x30};
		...
		if (target->delayMechanism == DM_P2P ||
			...
			if (config_get_int(cfg, NULL, "dataset_comparison") ==
				...
				if (target->paired_port) {
					profile_id = profile_id_62439_3_doubly;
				} else {
					profile_id = profile_id_62439_3_single;
				}
			} else {
